...
# to edit/delete tasks in your email use the -m switch to delete all emails in
# your tasks folder and afterwards the script will send you a new email with the
# current calcure task.csv file
...
-m	Merge together multiple task emails into a single file for easier management
"
exit
}
